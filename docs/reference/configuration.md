...
| line.tcp.min.idle.ms.before.writer.release | 30000        | Amount of time in milliseconds idle time before a table writer is released. Uncommitted data will be committed after this timeout.            |
