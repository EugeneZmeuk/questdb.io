...
author: Gábor Boros description: How to use the Telegraf agent to collect system
metrics from DigitalOcean droplets, store the metrics in QuestDB, and perform
basic data visualization and SQL queries using a time series database. image:
/img/tutorial/2021-07-09/banner.png
...
> protocol. – [questdb.io](//docs/reference/api/influxdb/)
...
[use the Grafana integration that QuestDB offers](/tutorial/2020/10/19/grafana/)
