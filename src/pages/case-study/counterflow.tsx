    ...
    >
      ...
      <section className={clsx(seCss.section, caCss.card)}>
        ...
        <p className={caCss.card__subtitle}>
          ...
          security systems devloped by Counterflow AI.
        </p>
      </section>
      ...
      <section className={seCss.section}>
        ...
        >
          <img
            ...
            width={791}
          />
          <h3>How we perform encrypted traffic analysis to secure networks</h3>
          ...
          <h3>
            Our analytics engine is designed to process millions of events per
            second
          </h3>
          <p className="font-size--large">
          ...
          <h3>Why high performance matters in streaming data analytics</h3>
          <p className="font-size--large">
